...
\begin{enumerate}[leftmargin=2em]
  ...
  \end{equation}
  is flat and surjective, then $\overline Y_H\subset X_\Sigma$ is a tropical compactification of $Y_H$; if the multiplication map is smooth and surjective, it is a schon tropical compactification;
...
\begin{enumerate}[leftmargin=2em]
  \item export a sidecar JSON containing the rational exponent table $A$, biases $b$, head/layer ids, active sets, projected hidden coordinates, and any ideal generators;

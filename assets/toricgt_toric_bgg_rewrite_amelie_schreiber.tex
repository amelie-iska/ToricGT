...
The active OAI-baseline adaptation uses the same principle in a wider SP1024
model: $V=1024$, $d=512$, $H=8$, $L=9$, tied embeddings, RoPE with
\texttt{ROPE\_BASE}=10000, sequence length $1024$, and a training-token batch
near $10^6$ tokens to use roughly the 20GB VRAM budget.  With first-class

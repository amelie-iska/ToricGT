...
route uses the smaller hash-context table to preserve artifact margin under the
$16{,}000{,}000$ byte cap.  None of these transferred modules may inspect the
unscored target SP token; on noncausal or cyclic graphs, their ordering signal
is the deterministic random reveal rank rather than an artificial direction.

...
\title{\vspace{-1.4em}ToricGT: Compact Graph-Token Reasoning with Tropical Ring Attention, Toric Diagnostics, and Soft-MoE Routing}
...
\end{align}
We use $E\ge4$ experts by default in the graph model.  The Parameter-Golf micro-LM uses a prefix-causal variant in which slot accumulators at position $t$ contain only strict-prefix tokens.

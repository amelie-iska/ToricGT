...
\end{equation}
so $i\to j$ and $j\to i$ may differ.  Periodic analyses render these noncommutative nested-complexes as directed filtration curves and heatmaps next to 3D graph-of-thought trajectories, Ramachandran-style phase plots, energy landscapes, and reasoning/K/BPB simplices.

...
contains structure-association records but no coordinate-bearing records; hence
graph/FoT structure association is active, while coordinate-native flow,
contact, distogram, and frame losses are implemented but dormant until true
PDB/AFDB or dynamics coordinates are curated.

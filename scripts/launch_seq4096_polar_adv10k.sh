...
RUN_ID="${RUN_ID:-toricgt_adv0ramp_polar_seq4096_${STAMP}}"
...
TRAIN_CMD=(
  ...
  "ADVANCED_LOSS_SCALE=0.0015"
  "GRAPHCG_LOSS_WEIGHT=0.0025"
  "TORIC_TROPICAL_LOSS_WEIGHT=0.0010"
  "SLEPIAN_LOSS_WEIGHT=0.0020"
  "KOSZUL_BGG_LOSS_WEIGHT=0.000005"
  "ANALOGY_LOSS_WEIGHT=0.000015"
  ...
  "ADVANCED_LOSS_WARMUP_STEPS=2000"
  "ADVANCED_LOSS_MIN_BEST_VAL_BPB=0"
  "ADVANCED_LOSS_MAX_CE_RATIO=0.00005"
  "GRAD_CLIP_NORM=1.0"
...
advanced:      start_step=0 every=1 warmup=2000 min_best_val_bpb=0 max_ce_ratio=0.00005 grad_clip=1.0
EOF
